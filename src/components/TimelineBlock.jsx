...
import { CATEGORIES, timeToTop, blockHeight } from '../utils'
  ...
  return (
    <div
      ...
      style={{
        top,
        height,
        backgroundColor: done ? '#F0ECE8' : cat.bg,
        borderLeft:      `3.5px solid ${done ? '#C4B8B0' : cat.color}`,
      }}
      onClick={onEdit}
    >
        ...
        <div className="flex-1 min-w-0 flex flex-col justify-center">
          ...
          {height >= 52 && (
            <p
              ...
              style={{ color: done ? '#C4B8B0' : `${cat.color}AA` }}
            >
